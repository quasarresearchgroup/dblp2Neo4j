...
public class PublisherRating implements Comparable<PublisherRating> {
   String name;
   String lastActive;
   Integer rating;
   
   public PublisherRating () {
        this.name = "-";
        this.lastActive = "-";
        this.rating = 0;
    }
    
    public PublisherRating (String name, String lastActive, int rating) {
        this.name = name;
    ...
    @Override
    public int compareTo(PublisherRating o) {
